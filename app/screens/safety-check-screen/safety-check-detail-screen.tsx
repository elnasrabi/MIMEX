...
export const SafetyCheckDetail: FunctionComponent<SafetyCheckDetailProps> = observer(props => {
  ...
  const [radio, updateRadio] = useState([{ isSelect: false }, { isSelect: false }]);
  const [radio1, updateRadio1] = useState([{ isSelect: false }, { isSelect: false }]);
  const [radio2, updateRadio2] = useState([{ isSelect: false }, { isSelect: false }]);
        ...
        <View style={RADIO_BUTTON_MAINVIEW}>
          <View style={RADIO_BUTTON_SUBVIEW}>
            <RadioButton
              ...
              onPress={() => {
                updateData([{ isSelect: true }, { isSelect: false }]);
              }}
            />
          ...
          <View style={[RADIO_BUTTON_SUBVIEW, { marginLeft: 10 }]}>
            <RadioButton
              ...
              onPress={() => {
                updateData([{ isSelect: false }, { isSelect: true }]);
              }}
            />
  ...
  return (
    <Screen
      ...
      preset="fixed"
    >
      <BackButton title={"safetyCheckDetailScreen.header"} onPress={goBack} />
      <ScrollView style={MAIN_VIEW}>
        ...
        <Text
          tx={"safetyCheckDetailScreen.comments"}
          style={[COMMON_TEXT, FONT_STYLE]}
          extraText={":"}
        />
        <TextField
