...
export interface NewContractRequestPaymentMethod {
...
let isBank = true;
export const NewContractRequestPaymentMethod: FunctionComponent<NewContractRequestPaymentMethod> = observer(
  props => {
    ...
    const onSave = async () => {
      ...
      console.log("ContractRequestStore.isContractSaved", ContractRequestStore.isContractSaved);
      if (ispercentright) {
        ContractRequestStore.NewContractRequest(
          ContractRequestStore.ContractObj,
