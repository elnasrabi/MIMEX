...
export interface NewContractRequestCommodity {
...
let isBank = true;
export const NewContractRequestCommodity: FunctionComponent<NewContractRequestCommodity> = observer(
  props => {
    ...
    const onSave = async () => {
      ...
      if (CommoditytoPost.length > 0) {
        ContractRequestStore.setContractCommodityObj(CommoditytoPost);

        props.navigation.navigate("NewContractRequestPaymentMethod");
      } else {
              ...
              <View style={DETAIL_CONTAINER}>
                ...
                <View style={ITEMS_VIEW}>
                  <View style={TextFiled_VIEW}>
                    <Text tx={"ContractRequestCommodity.QTY"} style={[ITEM_LABEL]} />
                  </View>
                  <TextField
