...
export const ComContractRequestPaymentMethodList: FunctionComponent<ComContractRequestCommodityListProps> = observer(
  props => {
    ...
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={Qty_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.PaymentMethodNameAR"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.Percentage"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractRequestCommodity.PaymentMethodNameAR}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractRequestCommodity.Percentage}
          </Text>
        </View>
      </View>
    );
