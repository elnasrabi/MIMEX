...
export interface ComContractRequestCommodityListProps {
...
export const ComContractRequestCommodityList: FunctionComponent<ComContractRequestCommodityListProps> = observer(
  props => {
    const { item, index } = props;
    const ContractRequestCommodity = item;
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={FLAT_LIST_VIEW}>
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.commname"}
            style={Name_LABEL}
            preset={"normal"}
          />
          <Text style={Name_VALUE} preset={"normal"}>
            {ContractRequestCommodity.CommodityNameAR}
          </Text>
        </View>
        <View style={Qty_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.Qty"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.price"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractRequestCommodity.Qty}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractRequestCommodity.UnitPrice}
          </Text>
        </View>
        ...
        <View style={UOM_View}>
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.uom"}
            style={UOM_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"ContractRequestDetail.desc"}
            style={Invoice_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={UOM_View}>
          <Text style={UOM_VALUE} preset={"normal"}>
            {ContractRequestCommodity.MeasurementUnitNameEN}
          </Text>
          <Text style={Invoice_VALUE} preset={"normal"}>
            {ContractRequestCommodity.CommodityCode}
          </Text>
        </View>

        {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"ContractRequestCommodityList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"ContractRequestCommodityList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
