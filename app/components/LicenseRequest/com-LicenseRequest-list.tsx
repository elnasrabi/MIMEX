...
export interface ComLicenseRequestListProps {
...
export const ComLicenseRequestList: FunctionComponent<ComLicenseRequestListProps> = observer(
  props => {
    const { item, index } = props;
    const { authStore } = useStores();
    const LicenseRequests = item;
    return (
      <View key={index} style={FLAT_LIST}>
        {!authStore.IsTrader && (
          <View style={FLAT_LIST_VIEW}>
            ...
            <Text
              style={TEXT_VALUE}
              text={LicenseRequests.FullName ? LicenseRequests.FullName : " "}
            />
          </View>
        )}
        <View style={FLAT_LIST_VIEW}>
          <Text
            extraText={":"}
            tx={"LicenseRequestList.RequestCode"}
            style={ITEM_LABEL}
            preset={"normal"}
          />
          <Text style={RequestCode_Value} preset={"normal"}>
            {LicenseRequests.LicenseRequestCode}
          </Text>
        </View>
        ...
        <View style={Amount_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"LicenseRequestList.amount"}
            style={Amount_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"LicenseRequestList.CurrencyShortName"}
            style={Amount_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Amount_Curr_VIEW}>
          <Text style={Amount_Curr_VALUE} preset={"normal"}>
            {LicenseRequests.TotalValue}
          </Text>
          <Text style={Amount_Curr_VALUE} preset={"normal"}>
            {LicenseRequests.CurrencyShortName}
          </Text>
        </View>
        ...
        <View style={Bank_Branch_VIEW}>
          <Text
            extraText={":"}
            tx={"LicenseRequestList.BankNameAR"}
            style={Bank_Branch_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"LicenseRequestList.BranchNameAR"}
            style={Bank_Branch_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Bank_Branch_VIEW}>
          <Text style={Bank_Branch_VALUE} preset={"normal"}>
            {LicenseRequests.BankNameAR}
          </Text>
          <Text style={Amount_Curr_VALUE} preset={"normal"}>
            {LicenseRequests.BranchNameAR}
          </Text>
        </View>
        ...
        <View style={Form_Status_View}>
          <Text
            extraText={":"}
            tx={"LicenseRequestList.requeststatus"}
            style={Form_Status_LABEL}
            preset={"normal"}
          />
          <Text style={Form_Status_VALUE} preset={"normal"}>
            {LicenseRequests.FlowStatusNameLicense}
          </Text>
        </View>

        {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"LicenseRequestList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"LicenseRequestList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
