...
export interface ComOperationCommodityListProps {
...
export const ComOperationCommodityList: FunctionComponent<ComOperationCommodityListProps> = observer(
  props => {
    const { item, index } = props;
    const OperationCommodity = item;
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={UOM_View}>
          <Text
            extraText={":"}
            tx={"OperationDetail.InitialInvoiceNumber"}
            style={UOM_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"OperationDetail.InitialInvoiceDate"}
            style={Invoice_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={UOM_View}>
          <Text style={UOM_VALUE} preset={"normal"}>
            {OperationCommodity.InitInvoiceNumber}
          </Text>
          <Text style={Invoice_VALUE} preset={"normal"}>
            {OperationCommodity.InitInvoiceDate[0].substring(0, 10)}
          </Text>
        </View>
        ...
        <View style={UOM_View}>
          <Text
            extraText={":"}
            tx={"OperationDetail.InitialInvoiceIssuer"}
            style={UOM_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={UOM_View}>
          <Text style={UOM_VALUE} preset={"normal"}>
            {OperationCommodity.InitInvoiceIssuer}
          </Text>
        </View>
        ...
        <View style={UOM_View}>
          <Text
            extraText={":"}
            tx={"OperationDetail.CommodityDesc"}
            style={UOM_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={UOM_View}>
          <Text style={UOM_VALUE} preset={"normal"}>
            {OperationCommodity.CommodityDesc}
          </Text>
        </View>

        {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"OperationCommodityList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"OperationCommodityList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
