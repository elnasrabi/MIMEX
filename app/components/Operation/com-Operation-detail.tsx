...
export interface ComOperationDetailProps {
...
const Operation_VIEW: TextStyle = { flex: 1, color: color.palette.link };
...
export const ComOperationDetail: FunctionComponent<ComOperationDetailProps> = observer(props => {
  const OperationStatus = props.data.FlowStatusNameIMOperation;
  if (OperationStatus === "Imported") {
    IsFinsished = true;
  } else {
    IsFinsished = false;
  }
      ...
      return (
        <ScrollView>
          <View style={DETAIL_CONTAINER}>
            <View style={Operation_VIEW}>
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.OperationCode"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
                <Text
                  ...
                  preset={"normal"}
                  text={props.data.OperationCode}
                />
              </View>
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.Exportername"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.ExporterCountry"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
                <Text
                  style={[TEXT_VALUE, { flex: 1 }]}
                  preset={"normal"}
                  text={props.data.ExporterCountryName}
                />
              </View>
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.creationdate"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.ImporterRegister"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.BranchNameAR"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.DocArrivalDate"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.ImportPurposeName"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"OperationDetail.CurrencyShortName"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
