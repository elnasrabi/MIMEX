...
export const ComOperationPaymentMethodList: FunctionComponent<ComOperationCommodityListProps> = observer(
  props => {
    ...
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={Qty_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"OperationDetail.PaymentMethodNameAR"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"OperationDetail.Percentage"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {OperationCommodity.PaymentMethodNameAR}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {OperationCommodity.Percentage}
          </Text>
        </View>
      </View>
    );
