...
export interface ComOperationListProps {
...
export const ComOperationList: FunctionComponent<ComOperationListProps> = observer(props => {
    ...
    <View key={index} style={FLAT_LIST}>
      {!authStore.IsTrader && (
        <View style={FLAT_LIST_VIEW}>
          ...
          <Text style={TEXT_VALUE} text={Operations.FullName ? Operations.FullName : " "} />
        </View>
      )}
      <View style={FLAT_LIST_VIEW}>
        <Text extraText={":"} tx={"OperationList.Code"} style={ITEM_LABEL} preset={"normal"} />
      ...
      <View style={Amount_Curr_VIEW}>
        <Text
          extraText={":"}
          tx={"OperationList.amount"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"OperationList.CurrencyShortName"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Amount_Curr_VIEW}>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Operations.TotalValue}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Operations.CurrencyShortName}
        </Text>
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text
          extraText={":"}
          tx={"OperationList.BankNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"OperationList.BranchNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text style={Bank_Branch_VALUE} preset={"normal"}>
          {Operations.BankNameAR}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Operations.BranchNameAR}
        </Text>
      </View>
      ...
      <View style={Form_Status_View}>
        <Text
          extraText={":"}
          tx={"OperationList.Country"}
          style={Form_Status_LABEL}
          preset={"normal"}
        />
        <Text style={Form_Status_VALUE} preset={"normal"}>
          {Operations.ExporterCountryName}
        </Text>
      </View>

      {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"OperationList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"OperationList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
