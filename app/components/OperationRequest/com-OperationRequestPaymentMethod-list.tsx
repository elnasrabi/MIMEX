...
export const ComOperationRequestPaymentMethodList: FunctionComponent<ComOperationRequestCommodityListProps> = observer(
  props => {
    ...
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={Qty_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"OperationRequestDetail.PaymentMethodNameAR"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"OperationRequestDetail.Percentage"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {OperationRequestCommodity.PaymentMethodNameAR}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {OperationRequestCommodity.Percentage}
          </Text>
        </View>
      </View>
    );
