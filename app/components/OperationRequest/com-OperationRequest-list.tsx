...
export interface ComOperationRequestListProps {
...
export const ComOperationRequestList: FunctionComponent<ComOperationRequestListProps> = observer(
  props => {
    const { item, index } = props;
    const { authStore } = useStores();
    const OperationRequests = item;
    return (
      <View key={index} style={FLAT_LIST}>
        {!authStore.IsTrader && (
          <View style={FLAT_LIST_VIEW}>
            ...
            <Text
              style={TEXT_VALUE}
              text={OperationRequests.FullName ? OperationRequests.FullName : " "}
            />
          </View>
        )}
        <View style={FLAT_LIST_VIEW}>
          <Text
            extraText={":"}
            tx={"OperationRequestList.RequestCode"}
            style={ITEM_LABEL}
            preset={"normal"}
          />
          <Text style={RequestCode_Value} preset={"normal"}>
            {OperationRequests.OperationRequestCode}
          </Text>
        </View>
        ...
        <View style={Amount_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"OperationRequestList.amount"}
            style={Amount_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"OperationRequestList.CurrencyShortName"}
            style={Amount_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Amount_Curr_VIEW}>
          <Text style={Amount_Curr_VALUE} preset={"normal"}>
            {OperationRequests.TotalValue}
          </Text>
          <Text style={Amount_Curr_VALUE} preset={"normal"}>
            {OperationRequests.CurrencyShortName}
          </Text>
        </View>
        ...
        <View style={Bank_Branch_VIEW}>
          <Text
            extraText={":"}
            tx={"OperationRequestList.BankNameAR"}
            style={Bank_Branch_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"OperationRequestList.BranchNameAR"}
            style={Bank_Branch_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Bank_Branch_VIEW}>
          <Text style={Bank_Branch_VALUE} preset={"normal"}>
            {OperationRequests.BankNameAR}
          </Text>
          <Text style={Amount_Curr_VALUE} preset={"normal"}>
            {OperationRequests.BranchNameAR}
          </Text>
        </View>
        ...
        <View style={Form_Status_View}>
          <Text
            extraText={":"}
            tx={"OperationRequestList.requeststatus"}
            style={Form_Status_LABEL}
            preset={"normal"}
          />
          <Text style={Form_Status_VALUE} preset={"normal"}>
            {OperationRequests.FlowStatusNameIMOperation}
          </Text>
        </View>

        {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"OperationRequestList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"OperationRequestList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
