...
export interface ComLicenseCommodityListProps {
...
export const ComLicenseCommodityList: FunctionComponent<ComLicenseCommodityListProps> = observer(
  props => {
    const { item, index } = props;
    const LicenseCommodity = item;
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={FLAT_LIST_VIEW}>
          <Text
            extraText={":"}
            tx={"LicenseDetail.commname"}
            style={Name_LABEL}
            preset={"normal"}
          />
          <Text style={Name_VALUE} preset={"normal"}>
            {LicenseCommodity.CommodityNameAR}
          </Text>
        </View>
        <View style={Qty_Curr_VIEW}>
          <Text extraText={":"} tx={"LicenseDetail.Qty"} style={Qty_Curr_LABEL} preset={"normal"} />
          <Text
            extraText={":"}
            tx={"LicenseDetail.price"}
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {LicenseCommodity.Qty}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {LicenseCommodity.UnitPrice}
          </Text>
        </View>

        <View style={UOM_View}>
          <Text extraText={":"} tx={"LicenseDetail.uom"} style={UOM_LABEL} preset={"normal"} />
          <Text extraText={":"} tx={"LicenseDetail.desc"} style={Invoice_LABEL} preset={"normal"} />
        </View>

        <View style={UOM_View}>
          <Text style={UOM_VALUE} preset={"normal"}>
            {LicenseCommodity.MeasurementUnitNameEN}
          </Text>
          <Text style={Invoice_VALUE} preset={"normal"}>
            {LicenseCommodity.CommodityCusCode}
          </Text>
        </View>

        {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"LicenseCommodityList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"LicenseCommodityList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
