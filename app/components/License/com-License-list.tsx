...
export interface ComLicenseListProps {
...
export const ComLicenseList: FunctionComponent<ComLicenseListProps> = observer(props => {
    ...
    <View key={index} style={FLAT_LIST}>
      {!authStore.IsTrader && (
        <View style={FLAT_LIST_VIEW}>
          ...
          <Text style={TEXT_VALUE} text={Licenses.FullName ? Licenses.FullName : " "} />
        </View>
      )}
      <View style={FLAT_LIST_VIEW}>
        <Text extraText={":"} tx={"LicenseList.Code"} style={ITEM_LABEL} preset={"normal"} />
      ...
      <View style={Amount_Curr_VIEW}>
        <Text
          extraText={":"}
          tx={"LicenseList.amount"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"LicenseList.CurrencyShortName"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text
          extraText={":"}
          tx={"LicenseList.BankNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"LicenseList.BranchNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Form_Status_View}>
        <Text
          extraText={":"}
          tx={"LicenseList.status"}
          style={Form_Status_LABEL}
          preset={"normal"}
        />
        <Text style={Form_Status_VALUE} preset={"normal"}>
          {Licenses.FlowStatusNameLicense}
        </Text>
      </View>

      {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"LicenseList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"LicenseList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
