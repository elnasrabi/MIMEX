...
export interface ComContractListProps {
...
export const ComContractList: FunctionComponent<ComContractListProps> = observer(props => {
  ...
  return (
    <View key={index} style={FLAT_LIST}>
      <View style={FLAT_LIST_VIEW}>
        <Text extraText={":"} tx={"ContractList.Code"} style={ITEM_LABEL} preset={"normal"} />
      ...
      <View style={Amount_Curr_VIEW}>
        <Text
          extraText={":"}
          tx={"ContractList.amount"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"ContractList.CurrencyShortName"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text
          extraText={":"}
          tx={"ContractList.BankNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"ContractList.BranchNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text style={Bank_Branch_VALUE} preset={"normal"}>
          {Contracts.BankNameAR}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Contracts.BranchNameAR}
        </Text>
      </View>
      ...
      <View style={Form_Status_View}>
        <Text
          extraText={":"}
          tx={"ContractList.status"}
          style={Form_Status_LABEL}
          preset={"normal"}
        />
        <Text style={Form_Status_VALUE} preset={"normal"}>
          {Contracts.FlowStatusNameContract}
        </Text>
      </View>

      {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"ContractList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"ContractList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
