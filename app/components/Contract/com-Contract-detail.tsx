...
export interface ComContractDetailProps {
...
const Contract_VIEW: TextStyle = { flex: 1, color: color.palette.link };
...
export const ComContractDetail: FunctionComponent<ComContractDetailProps> = observer(props => {
  const ContractStatus = props.data.FlowStatusNameContract;
  if (ContractStatus === "Imported") {
    IsFinsished = true;
  } else {
    IsFinsished = false;
  }
  ...
  const onActionPress = () => {
    props.navigation.navigate("ContractSpecial");
  };
  const onPhonePress = () => {
      ...
      return (
        <ScrollView>
          <View style={DETAIL_CONTAINER}>
            <View style={Contract_VIEW}>
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.ContractCode"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
                <Text
                  ...
                  preset={"normal"}
                  text={props.data.ContractCode}
                />
              </View>
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.importername"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.importeraddress"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.expirationdate"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.status"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
                <Text style={[TEXT_VALUE, { flex: 1 }]} preset={"normal"} text={ContractStatus} />
              </View>
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.creationdate"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.BranchNameAR"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.CurrencyShortName"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
              ...
              <View style={DETAIL_VIEW}>
                <Text
                  tx={"ContractDetail.note"}
                  extraText={":"}
                  style={ITEM_LABEL}
                  preset={"normal"}
                />
                <Text style={[TEXT_VALUE, { flex: 1 }]} text={props.data.Notes} preset={"normal"} />
              </View>
            </View>
          </View>
        </ScrollView>
