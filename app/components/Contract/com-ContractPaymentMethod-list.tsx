...
export const ComContractPaymentMethodList: FunctionComponent<ComContractCommodityListProps> = observer(
  props => {
    ...
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={Qty_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"ContractDetail.PaymentMethodNameAR"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"ContractDetail.Percentage"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractCommodity.PaymentMethodNameAR}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractCommodity.Percentage}
          </Text>
        </View>
      </View>
    );
