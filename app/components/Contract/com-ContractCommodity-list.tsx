...
export interface ComContractCommodityListProps {
...
export const ComContractCommodityList: FunctionComponent<ComContractCommodityListProps> = observer(
  props => {
    const { item, index } = props;
    const ContractCommodity = item;
    return (
      <View key={index} style={FLAT_LIST}>
        <View style={FLAT_LIST_VIEW}>
          <Text
            extraText={":"}
            tx={"ContractDetail.commname"}
            style={Name_LABEL}
            preset={"normal"}
          />
          <Text style={Name_VALUE} preset={"normal"}>
            {ContractCommodity.CommodityNameAR}
          </Text>
        </View>
        <View style={Qty_Curr_VIEW}>
          <Text
            extraText={":"}
            tx={"ContractDetail.Qty"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
          <Text
            extraText={":"}
            tx={"ContractDetail.price"}
            style={Qty_Curr_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={Qty_Curr_VIEW}>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractCommodity.Qty}
          </Text>
          <Text style={Qty_Curr_VALUE} preset={"normal"}>
            {ContractCommodity.UnitPrice}
          </Text>
        </View>

        <View style={UOM_View}>
          <Text extraText={":"} tx={"ContractDetail.uom"} style={UOM_LABEL} preset={"normal"} />
          <Text
            extraText={":"}
            tx={"ContractDetail.desc"}
            style={Invoice_LABEL}
            preset={"normal"}
          />
        </View>
        ...
        <View style={UOM_View}>
          <Text style={UOM_VALUE} preset={"normal"}>
            {ContractCommodity.MeasurementUnitNameEN}
          </Text>
          <Text style={Invoice_VALUE} preset={"normal"}>
            {ContractCommodity.CommodityCusCode}
          </Text>
        </View>

        {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"ContractCommodityList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"ContractCommodityList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
