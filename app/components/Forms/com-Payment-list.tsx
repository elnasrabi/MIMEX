...
export interface ComPaymentListProps {
...
export const ComPaymentList: FunctionComponent<ComPaymentListProps> = observer(props => {
    ...
    <View key={index} style={FLAT_LIST}>
      {!authStore.IsTrader && (
        <View style={FLAT_LIST_VIEW}>
          ...
          <Text style={TEXT_VALUE} text={Payments.FullName ? Payments.FullName : " "} />
        </View>
      )}
      <View style={FLAT_LIST_VIEW}>
        <Text extraText={":"} tx={"PaymentList.PaymentCode"} style={ITEM_LABEL} preset={"normal"} />
      ...
      <View style={Amount_Curr_VIEW}>
        <Text
          extraText={":"}
          tx={"PaymentList.Amount"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"PaymentList.CurrencyShortName"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Amount_Curr_VIEW}>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {currencyFormat(parseFloat(Payments.Amount))}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Payments.CurrencyShortName}
        </Text>
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text
          extraText={":"}
          tx={"PaymentList.PaymentDate"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"PaymentList.CorrespondentName"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text style={Bank_Branch_VALUE} preset={"normal"}>
          {Payments.PaymentDate[0].substring(0, 10)}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Payments.CorrespondentName}
        </Text>
      </View>
      ...
      <View style={Form_Status_View}>
        <Text
          extraText={":"}
          tx={"PaymentList.FlowStatusNamePayment"}
          style={Form_Status_LABEL}
          preset={"normal"}
        />
        <Text style={Form_Status_VALUE} preset={"normal"}>
          {Payments.FlowStatusNamePayment}
        </Text>
      </View>

      {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"PaymentList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"PaymentList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
