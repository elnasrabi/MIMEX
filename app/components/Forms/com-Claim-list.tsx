...
export interface ComClaimListProps {
...
export const ComClaimList: FunctionComponent<ComClaimListProps> = observer(props => {
    ...
    <View key={index} style={FLAT_LIST}>
      {!authStore.IsTrader && (
        <View style={FLAT_LIST_VIEW}>
          ...
          <Text style={TEXT_VALUE} text={Claims.FullName ? Claims.FullName : " "} />
        </View>
      )}

      <View style={FLAT_LIST_VIEW}>
        <Text extraText={":"} tx={"ClaimList.ClaimCode"} style={ITEM_LABEL} preset={"normal"} />
      ...
      <View style={Amount_Curr_VIEW}>
        <Text extraText={":"} tx={"ClaimList.amount"} style={Amount_Curr_LABEL} preset={"normal"} />
        <Text
          extraText={":"}
          tx={"ClaimList.CommodityName"}
      ...
      <View style={Amount_Curr_VIEW}>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {currencyFormatUSD(parseFloat(Claims.AmountUSD))}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {Claims.CommodityNameAR}
        </Text>
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text
          extraText={":"}
          tx={"ClaimList.BankNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"ClaimList.BranchNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"ClaimList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"ClaimList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
