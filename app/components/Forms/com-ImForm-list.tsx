...
export interface ComImFormListProps {
...
export const ComImFormList: FunctionComponent<ComImFormListProps> = observer(props => {
    ...
    <View key={index} style={FLAT_LIST}>
      {!authStore.IsTrader && (
        <View style={FLAT_LIST_VIEW}>
          ...
          <Text style={TEXT_VALUE} text={ImForms.FullName ? ImForms.FullName : " "} />
        </View>
      )}
      <View style={FLAT_LIST_VIEW}>
        <Text extraText={":"} tx={"ImFormList.FormCode"} style={ITEM_LABEL} preset={"normal"} />
      ...
      <View style={Amount_Curr_VIEW}>
        <Text
          extraText={":"}
          tx={"ImFormList.amount"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"ImFormList.CurrencyShortName"}
          style={Amount_Curr_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Amount_Curr_VIEW}>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {currencyFormat(parseFloat(ImForms.TotalValue))}
        </Text>
        <Text style={Amount_Curr_VALUE} preset={"normal"}>
          {ImForms.CurrencyShortName}
        </Text>
      </View>
      ...
      <View style={Bank_Branch_VIEW}>
        <Text
          extraText={":"}
          tx={"ImFormList.BankNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
        <Text
          extraText={":"}
          tx={"ImFormList.BranchNameAR"}
          style={Bank_Branch_LABEL}
          preset={"normal"}
        />
      </View>
      ...
      <View style={Form_Status_View}>
        <Text
          extraText={":"}
          tx={"ImFormList.formstatus"}
          style={Form_Status_LABEL}
          preset={"normal"}
        />
        <Text style={Form_Status_VALUE} preset={"normal"}>
          {ImForms.FlowStatusNameIM}
        </Text>
      </View>

      {/* <View style={FROM_TO_VIEW}>
        <View style={WEIGHT_VIEW}>
          <Text extraText={":"} tx={"ImFormList.wgt"} style={WEIGHT_LABEL} preset={"normal"} />
        ...
        <View style={VOLUME_VIEW}>
          <Text extraText={":"} tx={"ImFormList.vol"} style={WEIGHT_LABEL} preset={"normal"} />
          <Text style={TEXT_VALUE} preset={"normal"}>
            {cons.totalVolume}
          </Text>
        </View>
