 ...
 */
export const IssueText: React.FunctionComponent<TextFieldProps> = props => {
  const {
    placeholderTx,
    placeholder,
    labelTx,
  ...
  const IssueStyle : ViewStyle = { flex:1, borderBottomColor: '#000000',backgroundColor:"powderblue" ,
  borderBottomWidth: 1,};
