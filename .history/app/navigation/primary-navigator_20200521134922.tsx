...
const MainStack = createNativeStackNavigator<AuthParamList>()
...
export function ScreenNavigator() {
  return (
    ...
    >
      ...
      <MainStack.Screen name="consignmentDetail" component={ConsignmentDetail} />
      <MainStack.Screen name="pdfViewer" component={PDFViewer} />
      <MainStack.Screen name="consignmentSuccess" component={ConsignmentSuccess} />
    </MainStack.Navigator>
  )
}
