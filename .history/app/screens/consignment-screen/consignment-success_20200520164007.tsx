    ...
    <Screen statusBarColor={color.palette.white} statusBar={"dark-content"} wall={"whiteWall"} style={ROOT} preset="fixed">
      ...
      <ScrollView style={CONSIGNMENT_VIEW}>
        <View>
          ...
          <View style={{ height: 50, width: 150, borderColor: color.palette.darkText, borderWidth: 2 }}>
            <Picker
              selectedValue={selectedValue}
              style={{ height: 50, width: 150, borderColor: color.palette.darkText, borderWidth: 2 }}
