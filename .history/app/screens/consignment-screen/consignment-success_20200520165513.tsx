        ...
        <View>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1, justifyContent: "center", height: 50, width: 180, borderColor: color.palette.darkText, borderWidth: 3, borderRadius: 4 }}>
                <Picker
              ...
              <Text style={{ flex: 1, alignSelf: "flex-end" }} text={"11 March 2020 \n 11:15 am"} />
            </View>
