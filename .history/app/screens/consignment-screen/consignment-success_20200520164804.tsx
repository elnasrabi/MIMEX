      ...
      <ScrollView style={CONSIGNMENT_VIEW}>
        <View>
          ...
          <View style={{
            ...
            <View style={{ justifyContent: "center", height: 50, width: 180, borderColor: color.palette.darkText, borderWidth: 3, borderRadius: 4 }}>
              <Picker
                itemStyle={{ fontFamily: typography.primary, fontSize: 25 }}
