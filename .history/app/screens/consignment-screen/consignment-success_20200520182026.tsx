...
export const ConsignmentSuccess: FunctionComponent<ConsignmentSuccessProps> = observer(props => {
  ...
  const [fileName, setFileName] = useState("d")
  useEffect(() => {
  }, [])
        ...
        <View>
          ...
          <View style={STATUS_CONTAINER}>
            ...
            <View style={{ flexDirection: "row", marginTop: 5, alignItems: "center" }}>
              ...
              <TouchableOpacity style={{ flex: 1 }} onPress={onCameraPres}>
                <EvilIcons color={color.palette.darkText} name="camera" size={60} />
              </TouchableOpacity>
              <TouchableOpacity style={{ alignSelf: "center", marginStart: 15 }}>
                <Text style={{ color: color.palette.link, textDecorationLine: "underline" }} preset={"normal"} text={fileName} />
              </TouchableOpacity>
            </View>
            <TextField
