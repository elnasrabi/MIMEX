...
const DATE_TEXT: TextStyle = { flex: 1, textAlign: "right" }
        ...
        <View>
          ...
          <View style={STATUS_CONTAINER}>
            <View style={PICKER_CONTAINER}>
              ...
              <Text style={DATE_TEXT} text={"11 March 2020 \n11:15 am"} />
            </View>

            <EvilIcons style={{ marginTop: 10 }} color={color.palette.darkText} name="camera" size={60} />
